-- ============================================================
-- AI 智能体创作市场 — 数据库扩展（兼容 MySQL 5.7+）
-- ============================================================

-- 扩展 auth_users 表（忽略已存在的列错误）
ALTER TABLE auth_users ADD COLUMN subscription_plan VARCHAR(20) DEFAULT 'free';
ALTER TABLE auth_users ADD COLUMN api_key VARCHAR(64) UNIQUE;
ALTER TABLE auth_users ADD COLUMN total_tasks_count INT DEFAULT 0;
