...
CREATE TABLE IF NOT EXISTS agent_templates (
  ...
  model_recommended VARCHAR(50) DEFAULT 'qwen-max',
  inputs_schema JSON,
...
(UUID(), '长文写作团队', 'article-writer', '研究员+写手+编辑三智能体协同创作深度长文', '内容创作', 'qwen-plus', 15000, true, true,
 ...
 '[{"key":"topic","label":"文章主题","type":"text","required":true},{"key":"word_count","label":"字数要求","type":"number","default":3000},{"key":"audience","label":"目标读者","type":"text"},{"key":"style","label":"写作风格","type":"select","options":["专业严谨","轻松易读","学术深度"]}]'),
...
(UUID(), '社交媒体矩阵', 'social-matrix', '一键生成微博/微信/小红书多平台内容', '社交媒体', 'qwen-plus', 5000, true, true,
 ...
 '[{"key":"topic","label":"内容主题","type":"text","required":true},{"key":"brand","label":"品牌名称","type":"text"},{"key":"platforms","label":"发布平台","type":"multiselect","options":["微博","微信","小红书","抖音"]}]');
